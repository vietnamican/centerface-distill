...
traindataset = WiderFace(cfg.dataroot, cfg.annfile, cfg.sigma,
                         cfg.downscale, cfg.insize, None, cfg.train_transforms, 'train')
...
valdataset = WiderFace(cfg.dataroot, cfg.annfile, cfg.sigma,
                       cfg.downscale, cfg.insize, None, cfg.train_transforms, 'val')
...
log_name = 'centerface_logs/mobilenetv2vggblock/training'
