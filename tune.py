...
net.migrate(net.dla_up.state_dict(), net.filter_state_dict_with_prefix(checkpoint, 'dla_up'), force=True, verbose=2)
net.migrate(net.hm.state_dict(), net.filter_state_dict_with_prefix(checkpoint, 'hm'), force=True, verbose=2)
net.migrate(net.wh.state_dict(), net.filter_state_dict_with_prefix(checkpoint, 'wh'), force=True, verbose=2)
net.migrate(net.off.state_dict(), net.filter_state_dict_with_prefix(checkpoint, 'off'), force=True, verbose=2)
net.migrate(net.lm.state_dict(), net.filter_state_dict_with_prefix(checkpoint, 'lm'), force=True, verbose=2)
